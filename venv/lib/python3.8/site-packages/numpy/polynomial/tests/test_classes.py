"""Lab2 inter-conversion of different polynomial classes.
...
#
# Lab2 conversion methods that depend on combinations of two classes.
#
...
#
# Lab2 class method that only exists for some classes
#
