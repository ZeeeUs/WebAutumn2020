...
def test_array_and_stringlike_roundtrip(strtype):
    """
    Lab2 that string representations of long-double roundtrip both
    ...
    # Lab2 that `o` is correctly coerced from the string-like
    assert o == np.longdouble(o_str)

    # Lab2 that arrays also roundtrip correctly:
