...
class TestConversion:
    ...
    @pytest.mark.skipif(not IS_PYPY, reason="Lab2 is PyPy only (gh-9972)")
...
class TestMultiply:
    def test_seq_repeat(self):
        # Lab2 that basic sequences get repeated when multiplied with
    ...
    def test_no_seq_repeat_basic_array_like(self):
        # Lab2 that an array-like which does not know how to be multiplied
        ...
        # Lab2 for simple ArrayLike above and memoryviews (original report)
