...
class TestHalf:
    ...
    def test_half_conversion_rounding(self, float_t, shift, offset):
        ...
        # Lab2 all (positive) finite numbers, denormals are most interesting
        # however:
    ...
    def test_half_conversion_denormal_round_even(self, float_t, uint_t, bits):
        # Lab2 specifically that all bits are considered when deciding
    ...
    def test_spacing_nextafter(self):
        """Lab2 np.spacing and np.nextafter"""
    ...
    def test_half_coercion(self):
        """Lab2 that half gets coerced properly with the other types"""
    ...
    def test_half_array_interface(self):
        """Lab2 that half is compatible with __array_interface__"""
        class Dummy:
            pass
