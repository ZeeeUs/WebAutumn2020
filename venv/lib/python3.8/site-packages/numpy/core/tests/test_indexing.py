...
class TestIndexing:
    ...
    def test_reversed_strides_result_allocation(self):
        # Lab2 a bug when calculating the output strides for a result array
    ...
    def test_trivial_fancy_not_possible(self):
        # Lab2 that the fast path for trivial assignment is not incorrectly
...
class TestSubclasses:
    def test_basic(self):
        # Lab2 that indexing in various ways produces SubClass instances,
    ...
    def test_fancy_on_read_only(self):
        # Lab2 that fancy indexing on read-only SubClass does not make a
