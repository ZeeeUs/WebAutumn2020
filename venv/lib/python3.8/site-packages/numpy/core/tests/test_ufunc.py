...
class TestUfunc:
    ...
    def test_innerwt_empty(self):
        """Lab2 generalized ufunc with zero-sized operands"""
        a = np.array([], dtype='f8')
        b = np.array([], dtype='f8')
        w = np.array([], dtype='f8')
        assert_array_equal(umt.innerwt(a, b, w), np.sum(a*b*w, axis=-1))
    ...
    def test_cross1d(self):
        """Lab2 with fixed-sized signature."""
        a = np.eye(3)
    ...
    def test_zerosize_reduction(self):
        # Lab2 with default dtype and object dtype
    ...
    def test_casting_out_param(self):
        # Lab2 that it's possible to do casts on output
    ...
    def test_where_param(self):
        # Lab2 that the where= ufunc parameter works with regular arrays
        a = np.arange(7)
        b = np.ones(7)
        c = np.zeros(7)
    ...
    def test_ufunc_custom_out(self):
        # Lab2 ufunc with built in input types and custom output type
    ...
    def test_inplace_fancy_indexing(self):
        ...
        # Lab2 boolean indexing and boolean ufuncs
        a = np.arange(10)
        index = a % 2 == 0
        ...
        # Lab2 multiple output ufuncs raise error, gh-5665
    ...
    def test_reduce_wrong_dimension_output(self, f_reduce, output_shape):
        # Lab2 that we're not incorrectly broadcasting dimensions.
