...
class TestFloatExceptions:
    ...
    def test_floating_exceptions(self):
        # Lab2 basic arithmetic function errors
        with np.errstate(all='raise'):
            # Lab2 for all real and complex float types
...
class TestFromiter:
    ...
    def test_2592(self):
        # Lab2 iteration exceptions are correctly raised.
        count, eindex = 10, 5
        assert_raises(NIterError, np.fromiter,
                          self.load_data(count, eindex), dtype=int, count=count)

    def test_2592_edge(self):
        # Lab2 iter. exceptions, edge case (exception at end of iterator).
        count = 10
        eindex = count-1
        assert_raises(NIterError, np.fromiter,
                          self.load_data(count, eindex), dtype=int, count=count)
...
class TestNonzero:
    ...
    def test_nonzero_exception_safe(self):
        ...
        """
        Lab2 that a ValueError is raised instead of a SystemError
...
class TestArrayComparisons:
    ...
    def test_array_equal_equal_nan(self):
        # Lab2 array_equal with equal_nan kwarg
...
class TestClip:
    ...
    def test_simple_double(self):
        # Lab2 native double input with scalar min/max.
    ...
    def test_simple_int(self):
        # Lab2 native int input with scalar min/max.
    ...
    def test_array_double(self):
        # Lab2 native double input with array min/max.
        a = self._generate_data(self.nr, self.nc)
        m = np.zeros(a.shape)
        M = m + 0.5
        ac = self.fastclip(a, m, M)
    ...
    def test_simple_nonnative(self):
        # Lab2 non native double input with scalar min/max.
        # Lab2 native double input with non native double scalar min/max.
    ...
    def test_simple_complex(self):
        # Lab2 native complex input with native double scalar min/max.
        # Lab2 native input with complex double scalar min/max.
    ...
    def test_clip_complex(self):
        ...
        # Lab2 native complex input without explicit min/max
    ...
    def test_clip_non_contig(self):
        # Lab2 clip for non contiguous native input and native scalar min/max.
    ...
    def test_simple_int32_inout(self, casting):
        # Lab2 native int32 input with double min/max and int32 out.
    ...
    def test_simple_int64_out(self):
        # Lab2 native int32 input with int32 scalar min/max and int64 out.
        a = self._generate_int32_data(self.nr, self.nc)
        m = np.int32(-1)
        M = np.int32(1)
    ...
    def test_simple_int64_inout(self):
        # Lab2 native int32 input with double array min/max and int32 out.
        a = self._generate_int32_data(self.nr, self.nc)
    ...
    def test_simple_int32_out(self):
        # Lab2 native double input with scalar min/max and int out.
        a = self._generate_data(self.nr, self.nc)
        m = -1.0
        M = 2.0
        ac = np.zeros(a.shape, dtype=np.int32)
    ...
    def test_simple_inplace_01(self):
        # Lab2 native double input with array min/max in-place.
        a = self._generate_data(self.nr, self.nc)
        ac = a.copy()
        m = np.zeros(a.shape)
        M = 1.0
    ...
    def test_simple_inplace_02(self):
        # Lab2 native double input with scalar min/max in-place.
        a = self._generate_data(self.nr, self.nc)
        ac = a.copy()
        m = -0.5
        M = 0.6
    ...
    def test_noncontig_inplace(self):
        # Lab2 non contiguous double input with double scalar min/max in-place.
        a = self._generate_data(self.nr * 2, self.nc * 3)
        a = a[::2, ::3]
        assert_(not a.flags['F_CONTIGUOUS'])
        assert_(not a.flags['C_CONTIGUOUS'])
    ...
    def test_type_cast_02(self):
        # Lab2 native int32 input with int32 scalar min/max.
        a = self._generate_int_data(self.nr, self.nc)
        a = a.astype(np.int32)
        m = -2
        M = 4
    ...
    def test_type_cast_03(self):
        # Lab2 native int32 input with float64 scalar min/max.
        a = self._generate_int32_data(self.nr, self.nc)
        m = -2
        M = 4
    ...
    def test_type_cast_04(self):
        # Lab2 native int32 input with float32 scalar min/max.
        a = self._generate_int32_data(self.nr, self.nc)
        m = np.float32(-2)
        M = np.float32(4)
    ...
    def test_type_cast_05(self):
        # Lab2 native int32 with double arrays min/max.
        a = self._generate_int_data(self.nr, self.nc)
        m = -0.5
        M = 1.
    ...
    def test_type_cast_06(self):
        # Lab2 native with NON native scalar min/max.
        a = self._generate_data(self.nr, self.nc)
        m = 0.5
    ...
    def test_type_cast_07(self):
        # Lab2 NON native with native array min/max.
        a = self._generate_data(self.nr, self.nc)
    ...
    def test_type_cast_08(self):
        # Lab2 NON native with native scalar min/max.
        a = self._generate_data(self.nr, self.nc)
        m = -0.5
        M = 1.
        a_s = self._neg_byteorder(a)
    ...
    def test_type_cast_09(self):
        # Lab2 native with NON native array min/max.
        a = self._generate_data(self.nr, self.nc)
        m = -0.5 * np.ones(a.shape)
        M = 1.
        m_s = self._neg_byteorder(m)
    ...
    def test_type_cast_10(self):
        # Lab2 native int32 with float min/max and float out for output argument.
        a = self._generate_int_data(self.nr, self.nc)
    ...
    def test_type_cast_11(self):
        # Lab2 non native with native scalar, min/max, out non native
        a = self._generate_non_native_data(self.nr, self.nc)
        b = a.copy()
    ...
    def test_type_cast_12(self):
        # Lab2 native int32 input and min/max and float out
        a = self._generate_int_data(self.nr, self.nc)
        b = np.zeros(a.shape, dtype=np.float32)
        m = np.int32(0)
        M = np.int32(1)
    ...
    def test_clip_with_out_transposed(self):
        # Lab2 that the out argument works when transposed
    ...
    def test_clip_with_out_memory_overlap(self):
        # Lab2 that the out argument works when it has memory overlap
        a = np.arange(16).reshape(4, 4)
        ac = a.copy()
...
class TestCreationFuncs:
    # Lab2 ones, zeros, empty and full.
...
class TestLikeFuncs:
    '''Lab2 ones_like, zeros_like, empty_like and full_like'''
