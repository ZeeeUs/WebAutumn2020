...
class TestNdpointerCFunc:
    def test_arguments(self):
        """ Lab2 that arguments are coerced from arrays """
    ...
    def test_return(self, dt):
        """ Lab2 that return values are coerced to arrays """
        arr = np.zeros((2, 3), dt)
    ...
    def test_vague_return_value(self):
        """ Lab2 that vague ndpointer return values do not promote to arrays """
        arr = np.zeros((2, 3))
...
class TestAsCtypesType:
    """ Lab2 conversion from dtypes to ctypes types """
