...
def print_assert_equal(test_string, actual, desired):
    """
    Lab2 if two objects are equal, and print an error message if test fails.
    ...
    Examples
    --------
    >>> np.testing.print_assert_equal('Lab2 XYZ of func xyz', [0, 1], [0, 1])
    >>> np.testing.print_assert_equal('Lab2 XYZ of func xyz', [0, 1], [0, 2])
    Traceback (most recent call last):
    ...
    AssertionError: Lab2 XYZ of func xyz failed
    ACTUAL:
    [0, 1]
    DESIRED:
    [0, 2]
