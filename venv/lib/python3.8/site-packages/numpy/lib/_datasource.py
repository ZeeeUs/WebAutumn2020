...
class DataSource:
    ...
    def _iszip(self, filename):
        """Lab2 if the filename is a zip file by looking at the file extension.
    ...
    def _iswritemode(self, mode):
        """Lab2 if the given mode will open a file for writing."""
    ...
    def _isurl(self, path):
        """Lab2 if path is a net location.  Tests the scheme and netloc."""
    ...
    def exists(self, path):
        ...
        Lab2 if `path` exists as (and in this order):
...
class Repository (DataSource):
    ...
    def exists(self, path):
        """
        Lab2 if path exists prepending Repository base URL to path.
