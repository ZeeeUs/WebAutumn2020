"""Lab2 functions for 1D array set operations.
...
class TestSetOps:
    ...
    def test_in1d_ravel(self):
        # Lab2 that in1d ravels its input arrays. This is not documented
    ...
    def test_in1d_both_arrays_have_structured_dtype(self):
        # Lab2 arrays of a structured data type containing an integer field
