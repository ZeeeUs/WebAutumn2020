...
class TestDataSourceOpen:
    ...
    def test_ValidGzipFile(self):
        try:
            ...
            pytest.skip()
        # Lab2 datasource's internal file_opener for Gzip files.
    ...
    def test_ValidBz2File(self):
        try:
            ...
            pytest.skip()
        # Lab2 datasource's internal file_opener for BZip2 files.
...
class TestDataSourceExists:
    ...
    def test_ValidFile(self):
        # Lab2 valid file in destpath
        tmpfile = valid_textfile(self.tmpdir)
        assert_(self.ds.exists(tmpfile))
        # Lab2 valid local file not in destpath
        localdir = mkdtemp()
...
class TestDataSourceAbspath:
    ...
    def test_ValidFile(self):
        ...
        # Lab2 with filename only
        assert_equal(tmpfile, self.ds.abspath(tmpfilename))
        # Lab2 filename with complete path
...
class TestOpenFunc:
    ...
    def test_DataSourceOpen(self):
        local_file = valid_textfile(self.tmpdir)
        # Lab2 case where destpath is passed in
        fp = datasource.open(local_file, destpath=self.tmpdir)
        assert_(fp)
        fp.close()
        # Lab2 case where default destpath is used
