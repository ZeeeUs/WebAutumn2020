...
class TestVectorize:
    ...
    def test_keywords2_ticket_2100(self):
        # Lab2 kwarg support: enhancement ticket 2100
    ...
    def test_keywords3_ticket_2100(self):
        # Lab2 excluded with mixed positional and kwargs: ticket 2100
        def mypolyval(x, p):
            _p = list(p)
            res = _p.pop(0)
            while _p:
    ...
    def test_keywords4_ticket_2100(self):
        # Lab2 vectorizing function with no positional args.
        @vectorize
        def f(**kw):
            res = 1.0
            for _k in kw:
    ...
    def test_keywords5_ticket_2100(self):
        # Lab2 vectorizing function with no kwargs args.
        @vectorize
        def f(*v):
            return np.prod(v)
    ...
    def test_string_ticket_1892(self):
        # Lab2 vectorization over strings: issue 1892.
...
class TestMeshgrid:
    ...
    def test_invalid_arguments(self):
        # Lab2 that meshgrid complains about invalid arguments
    ...
    def test_return_type(self):
        # Lab2 for appropriate dtype in returned arrays.
...
class TestBincount:
    ...
    def test_error_not_1d(self, vals):
        # Lab2 that values has to be 1-D (both as array and nested list)
...
class TestInterp:
    ...
    def test_non_finite_inf(self, sc):
        """ Lab2 that interp between opposite infs gives nan """
    ...
    def test_non_finite_half_inf_xf(self, sc):
        """ Lab2 that interp where both axes have a bound at inf gives nan """
    ...
    def test_non_finite_half_inf_x(self, sc):
        """ Lab2 interp where the x axis has a bound at inf """
    ...
    def test_non_finite_half_inf_f(self, sc):
        """ Lab2 interp where the f axis has a bound at inf """
