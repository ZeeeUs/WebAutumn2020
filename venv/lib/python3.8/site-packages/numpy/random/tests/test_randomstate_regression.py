...
class TestRegression:
    ...
    def test_multivariate_normal_size_types(self):
        # Lab2 for multivariate_normal issue with 'size' argument.
    ...
    def test_beta_small_parameters(self):
        # Lab2 that beta with small a and b parameters does not produce
    ...
    def test_shuffle_of_array_of_different_length_strings(self):
        # Lab2 that permuting an array of different length strings
    ...
    def test_shuffle_of_array_of_objects(self):
        # Lab2 that permuting an array of objects will not cause
